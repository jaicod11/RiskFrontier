 ...
 *
 * Render suspends a free instance after 15 minutes idle; the next request waits
 * roughly 50 seconds while it boots. A bare spinner for that long reads as a
 * broken site, so past a couple of seconds we say what is happening, show a
 * counter that visibly advances, and give an honest upper bound.
 */
